...
export class CompanySetupComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        console.log('jitenfta',this.company_details);
        ...
        this.userService.newCompanySetup(this.usrFormGroup.value).pipe(first()).subscribe(
            (data: any) => {
                ...
                if (data.status_code == 200) {
                    ...
                    this.companyDeptAdd();
                    this.companySectionAdd();
                    this.companyuserContSetAdd();
                    // this.modulesPermissionGet();
                    // this.router.navigate(['/apps/picwall-pro']);
    ...
    // homepage() {
    //     this.router.navigate(['/apps/picwall-pro']);
    //     console.log('ffafafsafbhfhsafhashffd',);
    ...
    modulesPermissionGet() {
        ...
        this.userService.getMenuPermission(login_access_token, role_id).pipe(first()).subscribe(
            (data: any) => {
                console.log('jitendradd',data.la_menu);
