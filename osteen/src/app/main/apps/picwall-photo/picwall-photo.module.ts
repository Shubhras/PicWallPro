...
import { PicwallPhotoComponent } from 'app/main/apps/picwall-photo/picwall-photo.component';
...
const routes: Routes = [
    {
        path: '**',
        component: PicwallPhotoComponent,
        resolve: {
        }
    }
];
...
export class PicwallPhotoModule {
}
